...
powershell -Command "Compress-Archive -Path .\Scripts\, .\Seq\, .\SKSE\, .\LICENSE, .\PVE-Events.jsonc, .\PVE-Conditions.jsonc, .\PlayerVoiceEvents.esp, .\Sound\ -DestinationPath %ZIP_FILE%"
